...
circleTwo.addEventListener("click", () => {
    ...
    content.innerHTML = "SRIJAN is a unique initiative by The Entrepreneurship Cell, NIT Silchar, to motivate and educate people about entrepreneurship and to provide a meeting ground for Corporate experts and young entrepreneurs E Summit NIT Silchar.";
    timelineLogo.innerHTML = '<img class="timelineIcon" src="/images/Srijan-3.0.png">';
})
circleThree.addEventListener("click", () => {
    ...
    timelineLogo.innerHTML = '<img class="timelineIcon" src="/images/Timeline-Empressario.png">';
